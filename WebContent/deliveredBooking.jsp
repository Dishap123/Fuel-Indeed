            ...
            <div class="navbar-collapse">
				<nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
					<ul class="nav" id="side-menu">
						<li>
							<a href="deliveredBooking.jsp"><i class="fa fa-table nav_icon"></i>View Assigned Booking</a>
						</li>
						<li>
							<a href="deliveryPerson_ChangePass.html"><i class="fa fa-table nav_icon"></i>Change Password</a>
						</li>
...
<body>
    <div class="container">
        <div class="content-right">
            <h1 class="text-center mb-4" style="color: #4a4a4a;">Booking</h1>
        ...
        try {
            ...
            PreparedStatement ps = con.prepareStatement("select * from  booking where bstatus=? and dpid=?");
            ps.setString(1,"assigned");
            ps.setInt(2,Station.getDpid());
