            ...
            <div class="navbar-collapse">
				<nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
					<ul class="nav" id="side-menu">
						...
						<li>
							<a href="view_deliveredBooking.jsp"><i class="fa fa-table nav_icon"></i>View Delivered Booking</a>
						</li>
						<li>
...
<body>
    <div class="container">
        <div class="content-right">
            <h1 class="text-center mb-4" style="color: #4a4a4a;">Delivered Booking</h1>
            ...
            try {
                ...
                PreparedStatement ps = con.prepareStatement("SELECT * FROM booking WHERE bstatus=? and fid=?");
                ps.setString(1, "Delivered");
                ps.setInt(2,Station.getFid());
