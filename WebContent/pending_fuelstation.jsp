...
<body>
    <div class="container">
        <div class="content-right">
            <h1 class="text-center mb-4" style="color: #4a4a4a;">Fuel Station</h1>
	...
	try
	{
		...
		{%>
			<tr>
				...
				<td><a href="approve_Fuelstation.jsp?fid=<%=rs.getInt(1)%>">Approve</a></td>
				<td><a href="disapprove_Fuelstation.jsp?fid=<%=rs.getInt(1)%>">Disapprove</a></td>
			</tr>
